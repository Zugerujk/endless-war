...
#        str_desc = "These gaudish eyewear are almost always outdated by at least a year. The fuckheads that made these a thing should burn in hell. These glasses are from {yearint}!",
#        rarity = "Plebeian",
#       durability = 2500000,
#        style = "cute",
#        freshness = 5,
...
EwCosmeticItem(
    ...
    EwCosmeticItem(
        ...
        str_desc = "It's a miscellaneous collection of a soldier's decorations earned during their time. While you don't know what any of them mean, I think the amount of stolen valor you'll put on wearing these will give you the ire of all the old fucks that still live here.",
        rarity = "Plebeian",
        durability = 250000,
        style = "tough",
        freshness = 9,
    ...
    EwCosmeticItem( # Everything below is just bases for more cosmetics, in progress
        id_cosmetic = "###",
        str_name = "###",
        str_desc = "###",
        rarity = "Plebeian",
