...
EwFurniture(
    ...
    EwFurniture(
     ...
     EwFurniture(
        ...
        furniture_look_desc = "There's a chair here.",
        furn_set = "default",
    ),
     EwFurniture(
        id_furniture = "table",
    ...
    EwFurniture(
        id_furniture = "couch",
        str_name = "couch",
        str_desc = "A standard-issue couch accomodating 1-3 people.",
        rarity = "Plebeian",
        acquisition = "bartering",
        price = 150000,
        vendors = ['Based Hardware'],
        furniture_place_desc = "You haul in the pieces to carefully assemble a couch. After a disproportionate amount of struggling, you finally get everything in place.",
        furniture_look_desc = "There's a couch in the livingroom.",
        furn_set = "default",
    ),
