...
poi_list = [
	...
	EwPoi(
		...
		str_desc = "The middle of a great cavern. It smells like rotting fish. \nContinues onward to the **Raid Den Core**. Also connects to the **Raid Den Entryway**.",
		channel = "raid-den",
		permissions = {'raid-den': ['read', 'send', 'connect']},
		pvp = True,
        enemy_lock = True,
	...
	EwPoi(
		...
		str_desc = "The core of a great cavern, from which intense energy flows. \nExits into the **Downtown Subway Station**. Also connects to the **Raid Den Entryway**.",
		channel = "raid-den",
		permissions = {'raid-den': ['read', 'send', 'connect']},
		pvp = True,
        enemy_lock = True,
