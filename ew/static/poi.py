...
poi_list = [
	...
	EwPoi(
		...
		str_name = "The Moon",
		str_desc = "Hey wait, you're on the moon. How are you able to breathe? Well never mind that. You're doing it and that's what counts. There's a pretty sizable chunk taken out of it ever since N1 went and exploded. If only you could fish here, then you'd be able to fulfill your lifelong dream of imitating the guy from the Dreamworks logo. You've gotta go to a SUBZONE to do that. Or !loop back, or die, it's your decision.\n\nThis area continues to the Crest of the Crescent Moon.",
		channel = "the-moon",
