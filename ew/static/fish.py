...
if slimernalia_active == True:
    ...
    EwFish(
        ...
        catch_time = None,
        catch_weather = None,
        str_desc = "Long extinct in the usual tropical seawaters, it builds up frightening amounts of speed over periods of time. Its most known feature is their perpetually open mouth, hollering loud celebration wherever they go.",
        slime = "moon",
    ),
    EwFish(
    ...
    EwFish(
        id_fish = "festivefairyfish",
        str_name = "Festive Fairyfish",
        rarity = "common",
        catch_time = None,
        catch_weather = None,
        str_desc = "It has gaieties.",
        slime = "freshwater",
    ),
    EwFish(
        id_fish = "pineapplefruitcakefish",
        str_name = "Pineapplefruitcakefish",
        rarity = "common",
        catch_time = None,
        catch_weather = None,
        str_desc = "I'm sure it tastes alright.",
        slime = "saltwater",
    ),
    EwFish(
        id_fish = "slimernalligator",
        str_name = "Slimernalligator",
        rarity = "rare",
        catch_time = None,
        catch_weather = None,
        str_desc = "Full of holiday jeer.",
        slime = "freshwater",
    ),
    EwFish(
        id_fish = "macrocodile",
        str_name = "Macrocodile",
        rarity = "rare",
        catch_time = None,
        catch_weather = None,
        str_desc = "It's not banned anymore.",
        slime = "saltwater",
    ),
    EwFish(
        id_fish = "sledgehammerhead",
        str_name = "Sledgehammerhead",
        rarity = "promo",
        catch_time = None,
        catch_weather = None,
        str_desc = "A fair bit unbalanced.",
        slime = "saltwater",
    ),
    EwFish(
        id_fish = "rebornsaturnslime",
        str_name = "Reborn Saturnslime",
        rarity = "uncommon",
        catch_time = None,
        catch_weather = None,
        str_desc = "Better than a Uranusslime.",
        slime = "moon",
    ),
    EwFish(
        id_fish = "uranusslime",
        str_name = "Uranusslime",
        rarity = "promo",
        catch_time = None,
        catch_weather = None,
        str_desc = "It's getting hairy.",
        slime = "moon",
    ),
    EwFish(
        id_fish = "aspartamefish",
        str_name = "Aspartamefish",
        rarity = "uncommon",
        catch_time = None,
        catch_weather = None,
        str_desc = "Related to the Artifish and Sweetfish.",
        slime = "void",
    ),
    EwFish(
        id_fish = "phoebusjr",
        ...
        catch_time = None,
        catch_weather = None,
        str_desc = "Someone's been having a little too much fun.",
        slime = None,
    ),
    EwFish(
        id_fish = "evilneonjuvie",
        str_name = "Evil Neon Juvie",
        rarity = "common",
        catch_time = None,
        catch_weather = None,
        str_desc = "Has a kill count.",
        slime = "freshwater",
    ),
    EwFish(
        id_fish = "colebloodedicefish",
        str_name = "Cole Blooded Icefish",
        rarity = "common",
        catch_time = None,
        catch_weather = "snow",
        str_desc = "Got cabbage coursing through its veins.",
        slime = None,
    ),
    EwFish(
        id_fish = "drunkenchimaera",
        str_name = "Drunken Chimaera",
        rarity = "uncommon",
        catch_time = None,
        catch_weather = "snow",
        str_desc = "It went wayyyy overboard.",
        slime = None,
    ),
    EwFish(
        id_fish = "blacklimejollysalmon",
        str_name = "Black Lime Jolly Salmon",
        rarity = "rare",
        catch_time = None,
        catch_weather = "snow",
        str_desc = "Full of eggnog and !yo!",
        slime = None,
    ),
    EwFish(
        id_fish = "bluetoothfish",
        str_name = "Bluetoothfish",
        rarity = "promo",
        catch_time = None,
        catch_weather = "snow",
        str_desc = "The latency isn't ideal",
        slime = None,
    ),
])
