...
weapon_list = [
    ...
    EwWeapon(  # 48 
        ...
        str_kill="{name_player} twirls their rocket launcher after {name_target} gets their {hitzone} among other things blown up with everyone else that was nearby. After the fact, {name_player} is still reeling from the pain of shooting this thing less than 10 feet away from {target_player}.",
