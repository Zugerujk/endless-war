...
weapon_list = [
    EwWeapon(  # 1
        ...
        str_kill=random.choice(comm_cfg.revolverkilltext),
    ...
    EwWeapon(  # 2
        ...
        str_kill=random.choice(comm_cfg.dualpistolskilltext),
    ...
    EwWeapon(  # 3
        ...
        str_kill=random.choice(comm_cfg.shotgunkilltext),
    ...
    EwWeapon(  # 4
        ...
        str_kill=random.choice(comm_cfg.riflekilltext),
        str_killdescriptor="gunned down",
    ...
    EwWeapon(  # 5
        ...
        str_kill=random.choice(comm_cfg.smgkilltext),
    ...
    EwWeapon(  # 6
        ...
        str_kill=random.choice(comm_cfg.minigunkilltext),
    ...
    EwWeapon(  # 7
        ...
        str_kill=random.choice(comm_cfg.batkilltext),
    ...
    EwWeapon(  # 8
        ...
        str_kill=random.choice(comm_cfg.brassknuckleskilltext),
    ...
    EwWeapon(  # 9
        ...
        str_kill=random.choice(comm_cfg.katanakilltext),
    ...
    EwWeapon(  # 10
        ...
        str_kill=random.choice(comm_cfg.broadswordkilltext),
    ...
    EwWeapon(  # 11
        ...
        str_kill=random.choice(comm_cfg.nunchuckskilltext),
    ...
    EwWeapon(  # 12
        ...
        str_kill=random.choice(comm_cfg.scythekilltext),
    ...
    EwWeapon(  # 13
        ...
        str_kill=random.choice(comm_cfg.yoyokilltext),
    ...
    EwWeapon(  # 14
        ...
        str_kill=random.choice(comm_cfg.kniveskilltext),
    ...
    EwWeapon(  # 15
        ...
        str_kill=random.choice(comm_cfg.molotovkilltext),
    ...
    EwWeapon(  # 16
        ...
        str_kill=random.choice(comm_cfg.grenadekilltext),
        str_killdescriptor="exploded",
    ...
    EwWeapon(  # 17
        ...
        str_kill=random.choice(comm_cfg.garrotekilltext),
    ...
    EwWeapon(  # 18
        ...
        str_kill=random.choice(comm_cfg.pickaxekilltext),
    ...
    EwWeapon(  # 19
        ...
        str_kill=random.choice(comm_cfg.fishingrodkilltext),
    ...
    EwWeapon(  # 20
        ...
        str_kill=random.choice(comm_cfg.basskilltext),
    ...
    EwWeapon(  # 21
        ...
        str_kill=random.choice(comm_cfg.umbrellakilltext),
    ...
    EwWeapon(  # 22
        ...
        str_kill=random.choice(comm_cfg.bowkilltext),
    ...
    EwWeapon(  # 23
        ...
        str_kill=random.choice(comm_cfg.dclawkilltext),
    ...
    EwWeapon(  # 24
        ...
        str_kill=random.choice(comm_cfg.spraycankilltext),
    ...
    EwWeapon(  # 25
        ...
        str_kill=random.choice(comm_cfg.paintgunkilltext),
    ...
    EwWeapon(  # 26
        ...
        str_kill=random.choice(comm_cfg.paintrollerkilltext),
    ...
    EwWeapon(  # 27
        ...
        str_kill=random.choice(comm_cfg.paintbrushkilltext),
    ...
    EwWeapon(  # 28
        ...
        str_kill=random.choice(comm_cfg.watercolorskilltext),
    ...
    EwWeapon(  # 30
        ...
        str_kill=random.choice(comm_cfg.staffkilltext),
    ...
    EwWeapon(  # 31
        ...
        str_kill=random.choice(comm_cfg.hoekilltext),
    ...
    EwWeapon(  # 32
        ...
        str_kill=random.choice(comm_cfg.pitchforkkilltext),
    ...
    EwWeapon(  # 33
        ...
        str_kill=random.choice(comm_cfg.shovelkilltext),
    ...
    EwWeapon(  # 34
        ...
        str_kill=random.choice(comm_cfg.slimeringcankilltext),
    ...
    EwWeapon(  # 35
        ...
        # str_trauma_self = "A single clean scar runs across the entire length of your body.",
        # str_trauma = "A single clean scar runs across the entire length of their body.",
        str_kill=random.choice(comm_cfg.fingernailskilltext),
    ...
    EwWeapon(  # 35
        ...
        # str_trauma_self = "A single clean scar runs across the entire length of your body.",
        # str_trauma = "A single clean scar runs across the entire length of their body.",
        str_kill=random.choice(comm_cfg.roombakilltext),
    ...
    EwWeapon(  # 37
        ...
        str_kill=random.choice(comm_cfg.chainsawkilltext),
    ...
    EwWeapon(  # 38
        ...
        str_kill=random.choice(comm_cfg.huntingriflekilltext),
    ...
    EwWeapon(  # 42 AWP
        ...
        str_kill=random.choice(comm_cfg.sniperkilltext),
    ...
    EwWeapon(  # 43 DPick
        ...
        # str_trauma_self = "There is a deep, precise indent in the crown of your skull. How embarrassing!",
        # str_trauma = "There is a deep, precise indent in the crown of their skull. How embarrassing!",
        str_kill=random.choice(comm_cfg.diamondpickaxekilltext),
        str_killdescriptor="!mined",
        str_damage="{name_target} is lightly tapped on the {hitzone}!!",
    ...
    EwWeapon(  # 44
        ...
        # str_trauma_self = "You are covered in scarred-over lacerations and puncture wounds.",
        # str_trauma = "They are covered in scarred-over lacerations and puncture wounds.",
        str_kill=random.choice(comm_cfg.monowhipkilltext),
    ...
    EwWeapon(  # 45
        ...
        str_weaponmaster_self="",
        str_weaponmaster="",
        str_kill=random.choice(comm_cfg.unarmedkilltext),
    ...
    EwWeapon(  # 46
        ...
        str_kill=random.choice(comm_cfg.sledgehammerkilltext),
    ...
    EwWeapon(  # 47
        ...
        str_kill=random.choice(comm_cfg.skateboardkilltext),
    ...
    EwWeapon(  # 48
        ...
        str_kill=random.choice(comm_cfg.missilelauncherkilltext),
    ...
    EwWeapon(  # 44
        ...
        str_kill=random.choice(comm_cfg.pistolskilltext),
    ...
    EwWeapon(  # 44
        ...
        str_kill=random.choice(comm_cfg.combatknifekilltext),
    ...
    EwWeapon(  # 44
        ...
        str_kill=random.choice(comm_cfg.machetekilltext),
    ...
    EwWeapon(  # 44
        ...
        str_kill=random.choice(comm_cfg.boomerangkilltext),
