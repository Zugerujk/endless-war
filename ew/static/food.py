...
common_gumballs = ["gumball", "corpsegumball", "rowdygumball", "rowdywantedgumball", "killergumball", "killerwantedgumball", "dunggumball", "wrappingpapergumball", "jawbreaker"],
uncommon_gumballs = ["poketubergumball", "pulpgourdgumball", "sourpotatogumball", "bloodcabbagegumball", "joybeangumball" "purplekilliflowergumball", "razornutgumball", "pawpawgumball", "sludgeberrygumball", "suganmanutgumball", "pinkrowddishgumball", "dankwheatgumball", "brightshadegumball", "blacklimegumball", "phosphorpoppygumball", "direapplegumball", "rustealeafgumball", "metallicapgumball", "steelbeangumball", "aushuckgumball", "partypoppeppergumball"],
rare_gumballs = ["egggumball", "napalmorangegumball", "poudringumball", "sexgumball", "targumball", "slimecorpgumball", "bowlinggumball", "skullgumball", "musketgumball"],
superrare_gumballs = ["armageddongumball", "rainbowgumball", "ledgumball", "polarassaultfuckenergygumball", "nucleartastefuckenergygumball", "partypopcenturyblitzfuckenergygumball"],
food_list = [
    EwFood(
        id_food = "slimentonic",
        alias = ['tonic'],
    ...
    EwFood(
        id_food = "liamdtchocolates",
        alias = ['b'],
        recover_hunger = 250,
        price = 100000,
        str_name = "Liamdt Chocolates",
        str_eat = "d",
        str_desc = "e",
        time_expir = 43200,
        acquisition = "trickortreating",
    ...
    EwFood(
        ...
        price = 25000,
        str_name = "Zugumball",
        str_eat = "What the fuck. This is getting thrown out before the pull request.",
        str_desc = "What the fuck. https://media.discordapp.net/attachments/493472060270706689/903539745727062016/By_Meron_zoomed_in.png?width=178&height=178",
        time_expir = 600000,
    ),
