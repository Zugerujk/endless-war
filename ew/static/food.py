...
food_list = [
	...
	EwFood(
        ...
        vendors = ['The Breakroom', 'Mtn Dew Fountain', 'vending machine'],
        str_eat = "You crack open a cold, refreshing can of Twin Tower Tropical flavored FUCK ENERGY. You throw your head back and begin to chug it, the nostalgic taste of an late 90's tropical car freshener is enough to trigger your gag reflexes. But, you hold strong. The artificial pineapple, orange, guava flavour explodes in your mouth, you read the tagline on the side of the can 'A TASTE YOU WILL #NEVERFORGET' the crash of the memories of where YOU WERE overwhelms your senses, temporarily shutting off your brain from the sheer amount of information being sent to it from your overloaded taste buds. It's like 9/11 in your mouth. Nigh instantaneously the chemicals infiltrate your central nervous system. You feel an intense heat, like your body is about to spontaneously combust. You become lightheaded, your body twitching and convulsing randomly. And then, suddenly, you are launched into a manic, hyper-awareness. You begin to process more information in a single nanosecond than people with a masters in theoretical physics analyze in a lifetime. Your left and right brain sever, they now operate completely separately from one another and twice as efficiently. Your pineal gland doubles, nay, triples in size. You have never felt more alive. You crush the can with your forehead, screaming.",
        inebriation = 1000,
