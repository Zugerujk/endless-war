...
superrare_gumballs = ["armageddongumball", "rainbowgumball", "ledgumball", "polarassaultfuckenergygumball", "nucleartastefuckenergygumball", "partypopcenturyblitzfuckenergygumball", "radioheadgumball"]
food_list = [
    EwFood(
        id_food = "slimentonic",
        alias = ['tonic'],
